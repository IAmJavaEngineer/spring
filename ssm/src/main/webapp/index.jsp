...
<!-- 定义页面元素的功能 -->
	...
	<!-- 查询、分页功能 -->
		...
		function build_emps_table(result){
			...
			var emps = result.extend.pageInfo.list; //所有员工的信息
		...
		$("#emp_add_modal_btn").click(function(){
			...
			//调用函数发送ajax请求，查出部门信息，显示在下拉列表(select标签)中
			getDepts("#empAddModal select");
			
			//弹出添加员工的模态框(Bootstrap代码)
			$("#empAddModal").modal({
				backdrop:"static"
			});
		});
		...
		//添加员工模态框校验结果的提示信息样式(Bootstrap代码)
		...
		$(document).on("click",".edit_btn",function(){
			...
			//3、把员工的id传递给模态框中的更新按钮，
			//之前编辑按钮的edit-id属性已传入对应的员工id
